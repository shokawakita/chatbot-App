 ...
 * curl -X POST https://us-central1-chatbot-8636c.cloudfunctions.net/addDataset -H "Content-Type:application/json" -d @dataset.json
*/
// https://us-central1-chatbot-8636c.cloudfunctions.net/addDataset
...
export const addDataset = functions.https.onRequest(async (req: any, res: any) => {
    if (req.method !== 'POST') {
        ...
        for (const key of Object.keys(dataset)) {
            ...
            await db.collection('my-questions').doc(key).set(data)
        }
